...
class App{
    ...
    loadSketchfabModel() {
        ...
        const url = 'https://sketchfab.com/3d-models/tango-fbx-export-e3785c1fbf2f4842b25972197701c9fe'; // Replace with your Sketchfab model URL
        loader.load(url, (gltf) => {
            const scene = gltf.scene;
            scene.scale.set(2, 2, 2); // Adjust the scale of the model if needed
